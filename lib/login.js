...
export const login = {
  ...
  dydoLogin() {
    const uid = md5.hexMD5(this.$utils.uuid()).substr(8, 16)
    this.$utils.cookie.set('openid', 'dy' + uid, 1000 * 60 * 60 * 24 * 60, '.fangxin.com')
    this.$utils.cookie.set('uid', 'dy' + uid, 1000 * 60 * 60 * 24 * 60, '.fangxin.com')
    this.$utils.cookie.set('unionid', 'dy' + uid, 1000 * 60 * 60 * 24 * 60, '.fangxin.com')
  }
}
